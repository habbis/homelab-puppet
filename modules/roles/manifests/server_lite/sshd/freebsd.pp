...
class roles::server_lite::sshd::freebsd inherits roles::server_lite::sshd {

  $file_path = '/etc/ssh/ssh_host_ecdsa_key'

  if $facts['ssh_host_ecdsa_key'] == $file_path {
  ...
  file { '/etc/ssh/sshd_config':
    ...
    group   => wheel,
    mode    => '0600',
    content => epp('roles/sshd/freebsd/sshd_config.epp');
  }
